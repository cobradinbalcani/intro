...
class SQLiteDatabaseConnection:
    ...
    @check_session()
    def create_product(self, product_model: UsersSQLDBModel):
    ...
    def get_product_by_name(self, name):
        return self.session.query(ProductsSQLDBModel).filter(ProductsSQLDBModel.product_name == name).one_or_none()
